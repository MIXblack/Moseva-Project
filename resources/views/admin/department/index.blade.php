                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item m-2">
                                    <a class="nav-link btn btn-primary" href="{{route('admin.departments.index')}}">Add Department</a>
                                </li>
                        ...
                        <div class="row mt-4">
                                        ...
                                        {{csrf_field()}}
                                            ...
                                            <div class="card-body">
                                                <div class="form-group mt-1">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Deptment Name</label>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="form-group {{ $errors->has('department_name') ? 'has-error' : '' }}">
                                                                <div class="row gutters-sm">
                                                                    <div class="col">
                                                                        <input type="text" name="department_name" class="form-control" id="department_name"  placeholder="Developer...">
                            ...
                            <div class="col-lg-7">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title">Department Lists</div>
                                    </div>
                                                    ...
                                                    @if(count($Department) > 0)
                                                        @foreach($Department as $Departments)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="{{ url('/')}}/admin/pins/edit/{{ $Departments['id'] }}" class="btn btn-indigo btn-sm">
                                                                        <i class="fa fa-pencil mr-1"></i>
                                                                        Edit
                                                                    </a>

                                                                    <a href="{{ url('/')}}/admin/pins/destroy/{{ $Departments['id']}} " class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this user?');">
