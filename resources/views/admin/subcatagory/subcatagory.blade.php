                                                    ...
                                                    @if(count($Subcatagory) > 0)
                                                        @foreach($Subcatagory as $Subcatagorys)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="{{ url('/')}}/admin/pins/edit/{{ $Subcatagorys['id'] }}" class="btn btn-indigo btn-sm">
                                                                        <i class="fa fa-pencil mr-1"></i>
                                                                        Edit
                                                                    </a>
                
                                                                    <a href="{{ url('/')}}/admin/pins/destroy/{{ $Subcatagorys['id']}} " class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this user?');">
